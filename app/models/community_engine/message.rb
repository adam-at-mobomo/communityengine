...
class Message < ActiveRecord::Base  
  ...
  belongs_to :sender,     :class_name => CommunityEngine.user_class_name, :foreign_key => 'sender_id', :inverse_of => :sent_messages
  belongs_to :recipient,  :class_name => CommunityEngine.user_class_name, :foreign_key => 'recipient_id', :inverse_of => :received_messages
